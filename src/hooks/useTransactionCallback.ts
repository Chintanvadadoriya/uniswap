...
import { ChainId, Token } from "../library";
...
export function useTransactionCallback(): {
  ...
  harvest: (pid: Number, account: String, chainId: Number) => Promise<void>;
  resetTrxState: () => void;
} {
  ...
  const harvest = useCallback(
    async (pid: Number, account: String, chainId: Number) => {
      try {
