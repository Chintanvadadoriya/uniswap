...
import { Token, TokenAmount, JSBI, WETH } from "../../../library";
...
const Swap = (props) => {
  ...
  const parsedToken0Amount = useMemo(() => {
    ...
    const _token = new Token(
     ...
     console.log('_token11111-parsedToken0Amount', _token)
  ...
  console.log('parsedToken0Amount11111111111', parsedToken0Amount)
  ...
  const parsedToken1Amount = useMemo(() => {
    ...
    console.log('_token11111-parsedToken1Amount', _token)
  ...
  console.log('parsedTokenAmount11111111111', parsedToken0Amount)
